...
#define CLR_RS    digitalWrite(8, LOW) //no info as to which is which, low goes to command reg while high goes to data reg
#define SET_RS    digitalWrite(8, HIGH)
#define CLR_RESET digitalWrite(9, LOW) //reset is active low, so high should clear it
#define SET_RESET digitalWrite(9, HIGH) //WE CHANGED THIS WE CHANGED THIS==========================================================================================================================
#define CLR_CS    digitalWrite(10, LOW) //when this is high interface access is denied
#define SET_CS    digitalWrite(10, HIGH) //WE CHANGED THIS WE CHANGED THIS==========================================================================================================================
#define CLR_MOSI  digitalWrite(11, LOW) //no indication given
#define SET_MOSI  digitalWrite(11, HIGH)
#define CLR_SCK   digitalWrite(13, LOW) //no indication given
#define SET_SCK   digitalWrite(13, HIGH)
